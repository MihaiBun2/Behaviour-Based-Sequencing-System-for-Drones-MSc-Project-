...
class PathGeneratorDrone1(py_trees.behaviour.Behaviour):
   ...
   def update(self,path=1):
    ...
    # load the map
     gmap = OccupancyGridMap.from_png('maps/Asymetric_Obstacle_MAP.png', 1)
...
Merging_Offset=2+(DRONE1_Travel_Time_Flight_Seconds-DRONE2_Travel_Time_Flight_Seconds) #an offset of two seconds for merging resulting in a distance of 40 meters between each drone on the loitering line
print("Merging_Offset")
print(Merging_Offset)
